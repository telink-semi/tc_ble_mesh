...
mesh_cmd_sig_func_t mi_mesh_cmd_vd_func[] = {
	CMD_NO_STR(VD_MI_GET_PROPERTY, 		0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_SEPC_VENDOR_MODEL_SRV, mi_cb_vd_get_property, 	   	VD_MI_PROPERTY_STS),
    CMD_NO_STR(VD_MI_SET_PROPERTY, 		0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_SEPC_VENDOR_MODEL_SRV, mi_cb_vd_set_property, 		VD_MI_PROPERTY_STS),
	CMD_NO_STR(VD_MI_SET_PROPERTY_NO_ACK, 0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_SEPC_VENDOR_MODEL_SRV, mi_cb_vd_set_property_noack,VD_MI_PROPERTY_STS),
	CMD_NO_STR(VD_MI_PROPERTY_STS, 		1, MIOT_SEPC_VENDOR_MODEL_SRV, MIOT_SEPC_VENDOR_MODEL_CLI, mi_cb_vd_property_change_status, STATUS_NONE),
	CMD_NO_STR(VD_MI_ACTION, 				0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_SEPC_VENDOR_MODEL_SRV, mi_cb_vd_action, STATUS_NONE),
	CMD_NO_STR(VD_MI_RELAY_ACTION, 		0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_SEPC_VENDOR_MODEL_SRV, mi_cb_vd_reply_action, STATUS_NONE),
	CMD_NO_STR(VD_MI_EVENT_REPORT, 		0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_SEPC_VENDOR_MODEL_SRV, mi_cb_vd_event_report, STATUS_NONE),
		
	CMD_NO_STR(VD_MI_GW_NODE, 			0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_SEPC_VENDOR_MODEL_SRV, mi_cb_vd_vendor, STATUS_NONE),
	CMD_NO_STR(VD_MI_NODE_GW,				1, MIOT_SEPC_VENDOR_MODEL_SRV, MIOT_SEPC_VENDOR_MODEL_CLI, mi_cb_vd_vendor_sts,STATUS_NONE),


#if 0   // just for sample, default disable, 
  //CMD_NO_STR(VD_RC_KEY_REPORT, 0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_SEPC_VENDOR_MODEL_SRV, mi_cb_vd_key_report, STATUS_NONE),
#if DEBUG_VENDOR_CMD_EN
    CMD_NO_STR(VD_MI_LIGHT_ONOFF_SET, 0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_SEPC_VENDOR_MODEL_SRV, mi_cb_vd_light_onoff_set, VD_MI_LIGHT_ONOFF_STATUS),
	CMD_NO_STR(VD_MI_LIGHT_ONOFF_GET, 0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_SEPC_VENDOR_MODEL_SRV, mi_cb_vd_light_onoff_get, VD_MI_LIGHT_ONOFF_STATUS),
	CMD_NO_STR(VD_MI_LIGHT_ONOFF_SET_NOACK, 0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_SEPC_VENDOR_MODEL_SRV, mi_cb_vd_light_onoff_set, STATUS_NONE),
    CMD_NO_STR(VD_MI_LIGHT_ONOFF_STATUS, 1, MIOT_SEPC_VENDOR_MODEL_SRV, MIOT_SEPC_VENDOR_MODEL_CLI, mi_cb_vd_light_onoff_status, STATUS_NONE),
    #if MD_VENDOR_2ND_EN
    CMD_NO_STR(VD_MI_LIGHT_ONOFF_SET2, 0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_VENDOR_MD_SRV, mi_cb_vd_light_onoff_set2, VD_MI_LIGHT_ONOFF_STATUS2),
	CMD_NO_STR(VD_MI_LIGHT_ONOFF_GET2, 0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_VENDOR_MD_SRV, mi_cb_vd_light_onoff_get2, VD_MI_LIGHT_ONOFF_STATUS2),
	CMD_NO_STR(VD_MI_LIGHT_ONOFF_SET_NOACK2, 0, MIOT_SEPC_VENDOR_MODEL_CLI, MIOT_VENDOR_MD_SRV, mi_cb_vd_light_onoff_set2, STATUS_NONE),
    CMD_NO_STR(VD_MI_LIGHT_ONOFF_STATUS2, 1, MIOT_VENDOR_MD_SRV, MIOT_SEPC_VENDOR_MODEL_CLI, mi_cb_vd_light_onoff_status2, STATUS_NONE),
    #endif
#endif
#endif
};
