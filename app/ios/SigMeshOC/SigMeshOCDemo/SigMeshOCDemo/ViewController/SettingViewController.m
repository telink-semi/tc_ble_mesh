...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([titleString isEqualToString:@"Log"] || [titleString isEqualToString:@"Choose Add Devices"]) {
        sb = @"Main";
    }else if ([titleString isEqualToString:@"Test Add Devices"]) {
        sb = @"TestAddDevice";
    }
...
- (void)normalSetting{
    ...
    if (kTestChooseAdd) {
        [self.source addObject:@"Test Add Devices"];
        [self.iconSource addObject:@"ic_model"];
        [self.vcIdentifiers addObject:ViewControllerIdentifiers_TestAddDeviceVCID];
    }
