...
- (IBAction)changeBrightness:(UISlider *)sender {
    ...
    [DemoCommand changeBrightness:YES address:self.model.groupAddress para:sender.value isGet:NO respondMax:(int)self.model.groupOnlineDevices.count complete:^(ResponseModel *m) {
...
- (IBAction)changeTempareture:(UISlider *)sender {
    ...
    __weak typeof(self) weakSelf = self;
    [DemoCommand changeTemprature:YES address:self.model.groupAddress para:sender.value isGet:NO respondMax:(int)self.model.groupOnlineDevices.count complete:^(ResponseModel *m) {
        [weakSelf.collectionView reloadData];
    }];
}
