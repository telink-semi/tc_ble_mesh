...
/*默认一个unsegmented Access PDU的最大长度，大于该长度则需要进行segment分包，默认值为kUnsegmentedAccessMessageLowerTransportPDUMaxLength（15）*/
UIKIT_EXTERN UInt16 const kUnsegmentedAccessMessageLowerTransportPDUMaxLength;//15
