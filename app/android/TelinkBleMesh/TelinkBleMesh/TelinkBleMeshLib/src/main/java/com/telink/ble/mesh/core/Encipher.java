...
//        memcpy(r, iv, iv_len);
    ...
    private static int aes_att_decryption_packet_online_st(byte[] key, byte[] iv, int iv_len, byte[] mic, int mic_len, byte[] ps, int ps_len) {
        if (iv_len > 15) {
            return 0;
        }
        ...
        ///////////////// calculate enc ////////////////////////
        System.arraycopy(iv, 0, r, 1, iv_len);
...
//        memcpy(r + 1, iv, iv_len);
        ...
        System.out.println("ps: " + Arrays.bytesToHexString(ps, ":"));
        ///////////// calculate mic ///////////////////////
        r = new byte[16];
//        memset(r, 0, 16);
        System.arraycopy(iv, 0, r, 0, iv_len);
//        memcpy(r, iv, iv_len);
        r[iv_len] = (byte) len;
        r = aes(r, key);
