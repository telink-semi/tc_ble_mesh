 ...
 */
public class LcModeGetMessage extends LightingMessage {
    /**
     ...
     */
    public static LcModeGetMessage getSimple(int destinationAddress, int appKeyIndex, int rspMax) {
        LcModeGetMessage message = new LcModeGetMessage(destinationAddress, appKeyIndex);
     ...
     * @param appKeyIndex        The application key index.
     */
    public LcModeGetMessage(int destinationAddress, int appKeyIndex) {
    ...
    public int getOpcode() {
        return Opcode.LIGHT_LC_MODE_GET.value;
    }
    ...
    public int getResponseOpcode() {
        return Opcode.LIGHT_LC_MODE_STATUS.value;
    }
}
