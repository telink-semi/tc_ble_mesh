/********************************************************************************************************
 * @file LcLightOnOffGetMessage.java
 *
...
/**
 * This class represents a LcLightOnOffGetMessage, which is a type of LightingMessage.
 ...
 */
public class LcLightOnOffGetMessage extends LightingMessage {
    /**
     ...
     */
    public static LcLightOnOffGetMessage getSimple(int destinationAddress, int appKeyIndex, int rspMax) {
        LcLightOnOffGetMessage message = new LcLightOnOffGetMessage(destinationAddress, appKeyIndex);
     ...
     * @param appKeyIndex        The application key index.
     */
    public LcLightOnOffGetMessage(int destinationAddress, int appKeyIndex) {
    ...
    public int getOpcode() {
        return Opcode.LIGHT_LC_ONOFF_GET.value;
    }
    ...
    public int getResponseOpcode() {
        return Opcode.LIGHT_LC_ONOFF_STATUS.value;
    }
}
