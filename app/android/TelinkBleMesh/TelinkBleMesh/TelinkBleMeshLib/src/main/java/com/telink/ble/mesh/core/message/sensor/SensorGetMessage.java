 ...
 */
public class SensorGetMessage extends GenericMessage {
    // Property ID
     ...
     */
    public static SensorGetMessage getSimple(int address, int appKeyIndex, Integer propertyID) {
        SensorGetMessage message = new SensorGetMessage(address, appKeyIndex);
     ...
     * @param appKeyIndex        The application key index.
     */
    public SensorGetMessage(int destinationAddress, int appKeyIndex) {
    ...
    public int getResponseOpcode() {
        return Opcode.SENSOR_STATUS.value;
    }
    ...
    public int getOpcode() {
        return Opcode.SENSOR_GET.value;
    }
