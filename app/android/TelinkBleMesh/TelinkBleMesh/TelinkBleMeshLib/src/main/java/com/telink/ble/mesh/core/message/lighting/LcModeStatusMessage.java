 ...
 */
public class LcModeStatusMessage extends StatusMessage implements Parcelable {
     ...
     */
    protected LcModeStatusMessage(Parcel in) {
        mode = in.readByte();
    }
     ...
     */
    public static final Creator<LcModeStatusMessage> CREATOR = new Creator<LcModeStatusMessage>() {
        @Override
        public LcModeStatusMessage createFromParcel(Parcel in) {
            return new LcModeStatusMessage(in);
        }

        @Override
        public LcModeStatusMessage[] newArray(int size) {
            return new LcModeStatusMessage[size];
        }
    };
