...
//    public static final int STATE_INPUT_COMPLETE = 0x1005;
    ...
    private static final long TIMEOUT_PROVISIONING = 20 * 1000;
...
//    private ProvisioningParams mProvisioningParams;
    ...
    // root cert in pts
    private byte[] rootCert = Arrays.hexToBytes("");
...
//            recordData = ByteBuffer.allocate(recordData.length + newRecordData.length).put(recordData).put(newRecordData).array();
    ...
    private void onAllRecordsComplete() {
        ...
        if (recordContents.size() == 1) {
            // only contains Certificate-based Provisioning URI
            ...
            final byte[] deviceCertData = recordContents.get(1);
            final byte[] intermediateCertData = recordContents.get(2);
            if (rootCert == null) {
