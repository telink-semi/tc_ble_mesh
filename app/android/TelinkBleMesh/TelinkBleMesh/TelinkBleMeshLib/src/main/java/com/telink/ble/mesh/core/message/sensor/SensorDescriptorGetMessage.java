/********************************************************************************************************
 * @file SensorDescriptorGetMessage.java
 *
...
/**
 * This class represents a message for getting Sensor Descriptor.
 ...
 */
public class SensorDescriptorGetMessage extends GenericMessage {
    // Property ID
     ...
     */
    public static SensorDescriptorGetMessage getSimple(int address, int appKeyIndex, Integer propertyID) {
        SensorDescriptorGetMessage message = new SensorDescriptorGetMessage(address, appKeyIndex);
     ...
     * @return The scheduler action get message.
     */
    public static SensorDescriptorGetMessage getAll(int address, int appKeyIndex) {
        SensorDescriptorGetMessage message = new SensorDescriptorGetMessage(address, appKeyIndex);
     ...
     * @param appKeyIndex        The application key index.
     */
    public SensorDescriptorGetMessage(int destinationAddress, int appKeyIndex) {
    ...
    public int getResponseOpcode() {
        return Opcode.SENSOR_DESCRIP_STATUS.value;
    }
    ...
    public int getOpcode() {
        return Opcode.SENSOR_DESCRIP_GET.value;
    }
