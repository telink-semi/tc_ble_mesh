 ...
 *
 *******************************************************************************************************/
package com.telink.file.selector;
...
//    private static final String KEY_SORT_TYPE = "com.telink.bluetooth.light.KEY_SORT_TYPE";
    ...
    public static void saveSkip(Context context, boolean skip) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean(KEY_SKIP, skip)
                .apply();
    }

    public static boolean getSkip(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
        return sharedPreferences.getBoolean(KEY_SKIP, false);
    }
