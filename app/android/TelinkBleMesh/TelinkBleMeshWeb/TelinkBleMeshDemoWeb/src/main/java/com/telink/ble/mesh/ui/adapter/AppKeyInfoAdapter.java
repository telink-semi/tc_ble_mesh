...
import com.telink.ble.mesh.web.entity.MeshApplicationKey;

import java.util.List;

public class AppKeyInfoAdapter extends BaseRecyclerViewAdapter<AppKeyInfoAdapter.ViewHolder> {

    private List<MeshApplicationKey> keyList;
    private Context mContext;

    public AppKeyInfoAdapter(Context context, List<MeshApplicationKey> keyList) {
        mContext = context;
