...
public class NetworkingDevice {
    ...
    public TelinkPlatformUuidInfo uuidInfo;
...
//    public MeshNode nodeInfo;
    ...
    public static final String TAG_REMOTE_PV = "remote-provision";

    /*public NetworkingDevice(MeshNode nodeInfo) {
