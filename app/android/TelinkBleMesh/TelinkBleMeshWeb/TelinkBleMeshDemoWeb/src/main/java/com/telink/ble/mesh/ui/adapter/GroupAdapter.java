...
public class GroupAdapter extends BaseRecyclerViewAdapter<GroupAdapter.ViewHolder> {
    ...
    private List<MeshGroup> mGroups;

    public GroupAdapter(Context context, List<MeshGroup> groups) {
        this.mContext = context;
        this.mGroups = groups;
    }

    public void resetGroups(List<MeshGroup> groups) {
        this.mGroups = groups;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        MeshGroup group = mGroups.get(position);
