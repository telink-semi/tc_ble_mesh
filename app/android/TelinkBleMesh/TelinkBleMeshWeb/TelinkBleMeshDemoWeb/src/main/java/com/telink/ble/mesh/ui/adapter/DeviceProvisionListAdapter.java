...
//        MeshNode nodeInfo = device.nodeInfo;
        ...
        String deviceDesc = mContext.getString(R.string.device_prov_desc, device.address == -1 ? "[Unallocated]" : "0x" + String.format("%04X", device.address), Arrays.bytesToHexString(device.deviceUUID));
