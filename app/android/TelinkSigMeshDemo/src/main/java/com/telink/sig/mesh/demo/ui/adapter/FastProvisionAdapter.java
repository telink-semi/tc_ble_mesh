 ...
 */
public class FastProvisionAdapter extends BaseRecyclerViewAdapter<FastProvisionAdapter.ViewHolder> {
    List<DeviceInfo> mDevices;
    Context mContext;

    public FastProvisionAdapter(Context context, List<DeviceInfo> devices) {
        mContext = context;
        mDevices = devices;
    }
