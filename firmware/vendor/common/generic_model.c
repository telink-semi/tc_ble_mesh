...
const mesh_cmd_sig_func_t mesh_cmd_sig_func[] = {
	...
	#else
    CMD_NO_STR(REMOTE_PROV_SCAN_START,0,SIG_MD_REMOTE_PROV_CLIENT,SIG_MD_REMOTE_PROV_SERVER,mesh_cmd_sig_rp_scan_start,REMOTE_PROV_SCAN_STS),
	#endif
	...
	CMD_NO_STR(REMOTE_PROV_LINK_OPEN,0,SIG_MD_REMOTE_PROV_CLIENT,SIG_MD_REMOTE_PROV_SERVER,mesh_cmd_sig_rp_link_open,REMOTE_PROV_LINK_REPORT),
	#else
    ...
    // generic
    CMD_NO_STR(G_ONOFF_GET, 0, SIG_MD_G_ONOFF_C, SIG_MD_G_ONOFF_S, mesh_cmd_sig_g_onoff_get, G_ONOFF_STATUS),
    CMD_NO_STR(G_ONOFF_SET, 0, SIG_MD_G_ONOFF_C, SIG_MD_G_ONOFF_S, mesh_cmd_sig_g_onoff_set, G_ONOFF_STATUS),
    CMD_NO_STR(G_ONOFF_SET_NOACK, 0, SIG_MD_G_ONOFF_C, SIG_MD_G_ONOFF_S, mesh_cmd_sig_g_onoff_set, STATUS_NONE),
    CMD_NO_STR(G_ONOFF_STATUS, 1, SIG_MD_G_ONOFF_S, SIG_MD_G_ONOFF_C, mesh_cmd_sig_g_onoff_status, STATUS_NONE),
...
#if MD_OP_AGG_EN
    #if MD_SERVER_EN
	{SIG_MD_OP_AGG_S, GET_SINGLE_MODEL_AND_COUNT(model_sig_op_agg.srv, 0)},
    #endif
#if MD_CFG_CLIENT_EN
	{SIG_MD_OP_AGG_C, GET_SINGLE_MODEL_AND_COUNT(model_sig_op_agg.clnt, 0)},
#endif	
#endif
