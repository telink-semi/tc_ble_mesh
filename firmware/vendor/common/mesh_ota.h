...
#define BLOB_PARTIAL_BLOCK_REPORT	    0x4F    // used for pull mode(LPN)
...
enum{
	...
	UPLOAD_PHASE_OOB_TRANSFER_ACTIVE 	= 2,
	UPLOAD_PHASE_TRANSFER_ERROR			= 3,
	UPLOAD_PHASE_TRANSFER_SUCCESS		= 4,
	UPLOAD_ST_MAX,
};
...
enum{
    ...
    UPDATE_PHASE_MAX,
    UPDATE_PHASE_PTS_8	= 8,				// FD/BV-25, 41:update phase 8 is what ?
};
...
#if MESH_OTA_PULL_MODE_EN
#define MESH_OTA_TRANSFER_MODE_SEL      (MESH_OTA_TRANSFER_MODE_PULL) // | MESH_OTA_TRANSFER_MODE_PUSH
#else
...
typedef struct{
	...
	blob_block_start_t block_start;     // 0x1C:2 byte align here
...
//extern fw_initiator_proc_t fw_initiator_proc;
...
extern const fw_id_t fw_id_local;
