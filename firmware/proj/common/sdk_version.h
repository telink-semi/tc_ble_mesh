...
#define SDK_VER_MAJOR			(3)		// SDK version, don't change!!! 
#define SDK_VER_MINOR			(3)		// SDK version, don't change!!! 
#define SDK_VER_2ND_MINOR		(5)		// SDK version, don't change!!!	// second minor

#define SDK_VER_PATCH			(1)		// SDK version, don't change!!!	// patch version, 0 or not nothing means no patch.
