...
void dfifo_init(){
	...
	reg_dfifo_buf_thres = MASK_VAL(FLD_DFIFO0_LO_THRES, DFIFO0_SIZE>>6, FLD_DFIFO0_HI_THRES, (DFIFO0_SIZE>>4)-(DFIFO0_SIZE>>6),
		FLD_DFIFO1_HI_THRES, DFIFO1_SIZE>>5, FLD_DFIFO2_HI_THRES, DFIFO2_SIZE>>5);
#endif
...
#if (MODULE_MIC_ENABLE || USB_MIC_ENABLE)
	#if(MIC_SAMPLE_RATE <= 16000)		//  2M / 128,   在 aud_init  中微调
